...
data_name = "S12_mod_2_gauss_kernel"
add <- function(x) Reduce("+", x)

S12_B1 <- read_csv("data/S12-B1.csv")
data_1 = S12_B1 %>% as.matrix
S12_B2 <- read_csv("data/S12-B2.csv")
data_2 = S12_B2 %>% as.matrix
S12_B3 <- read_csv("data/S12-B3.csv")
data_3 = S12_B3 %>% as.matrix
