...
parameter_set_agent = makeParamSet(makeIntegerVectorParam(
  id= "x",
  len = 2,
  lower = 30,
  upper = 50,
...
design_agent <- generateDesign(n = init_design_size_agent, par.set = parameter_set_agent, fun = lhs::maximinLHS)
#ctrl <- makeMBOControl(final.method = "best.true.y", final.evals = 5)
lambda_agent = 1
