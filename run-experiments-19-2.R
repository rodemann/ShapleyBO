...
n_exp = 3 # number of experimental repetition per subject

budget = 20
init_design_size = 5
#init_design_size_agent = 25

#lambda = 20

# note: slightly harder problem

# run experiments for all study subjects
for(dat_nr in 13:14){
  for (lambda_agent in c(20,40,60)) {
    for (init_design_size_agent in c(40,60,80,100)) {
   #lambda_agent = 20   
      lambda = lambda_agent
      print(dat_nr)
