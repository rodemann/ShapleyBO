...
data_name = "S11_mod_2_gauss_kernel"
add <- function(x) Reduce("+", x)

S11_B1 <- read_csv("data/S11-B1.csv")
data_1 = S11_B1 %>% as.matrix
S11_B2 <- read_csv("data/S11-B2.csv")
data_2 = S11_B2 %>% as.matrix
S11_B3 <- read_csv("data/S11-B3.csv")
data_3 = S11_B3 %>% as.matrix
