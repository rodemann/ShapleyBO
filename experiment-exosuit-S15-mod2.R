...
data_name = "S15_mod_2_gauss_kernel"
add <- function(x) Reduce("+", x)

S15_B1 <- read_csv("data/S15-B1.csv")
data_1 = S15_B1 %>% as.matrix
S15_B2 <- read_csv("data/S15-B2.csv")
data_2 = S15_B2 %>% as.matrix
S15_B3 <- read_csv("data/S15-B3.csv")
data_3 = S15_B3 %>% as.matrix
